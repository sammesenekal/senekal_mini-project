...
| ln_conc | Natural Logarithm of Concentration | The natural logarithm of plasma concentration, used to linearize the elimination phase | Numeric (Continuous) | Real Numbers | Mandatory | 1.04, 2.05 | Calculated by taking the natural logarithm of concentration (ln(conc)) from the raw Theoph data set |
